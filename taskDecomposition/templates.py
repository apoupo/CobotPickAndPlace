TaskTemplate= """I need you to generate subtasks for each of the tasks. Assume the gripping device is a robot arm and u are talking to the robot.
            ...
            And it has gripper. Here is an example.
            Example:
...
TaskBlockDirectionTemplate= """
            I need you to generate subtasks for each of the tasks. Assume the gripping device is a robot arm and u are talking to the robot.
            ...
            I need the output in this format
            Task: Place the {block1} {direction} {block2}.
            Subtasks:
            """
